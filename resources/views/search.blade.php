          ...
          <div class="container">
            <div class="row">
                <div class="col-md-12">
                  <nav class="breadcrumb"  style="border: 1px solid rgba(0,0,0,.125);border-radius: 0px; background-color: white">
                      ...
                      <a class="breadcrumb-item active" style="font-weight: bold">{{$value}}</a>
                  </nav>
                </div>
            </div>
            <div style="height: 1350px">
                @if(count($categorys) > 0)
                        <div class="row">
                            <div class="col-md">
                                    <h5>Kết quả tìm kiết cho <i style="color: green">" {{$value}} "</i> có {{count($categorys)}} sản phẩm được tìm thấy</h5>
                                    <br>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md">
                            <h5>Không tìm thấy sản phẩm nào cho <i style="color: green">" {{$value}} "</h5>
                    </div>
                </div>
                @endif
            </div>
